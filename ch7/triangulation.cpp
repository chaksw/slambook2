/*
 * @Author: Runsheng WU 
 * @Date: 2020-07-15 16:51:07 
 * @Last Modified by: Runsheng WU
 * @Last Modified time: 2020-07-15 17:30:46
 */
...
int main(int argc, char **argv)
{
    ...
    for (int i = 0; i < matches.size(); i++)
    {
        ...
        circle(img1_plot, keypoints_2[matches[i].queryIdx].pt, 2, get_color(depth2), 2);
    }
    ...
    vector<DMatch> &matches)
{
    ...
    // 找出所有匹配之间最小距离和最大距离， 即是最相似的和最不相似的两组点之间的距离
